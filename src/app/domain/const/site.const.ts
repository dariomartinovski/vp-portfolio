/** The designer this portfolio belongs to. Referenced by the navbar, footer, hero and SEO. */
export const PERSON_NAME = 'Robert Martinovski';

export const PERSON_ROLE = 'Digital Illustrator & Designer';

/**
 * The brand Robert works under. Used as a supporting identity — `og:site_name`,
